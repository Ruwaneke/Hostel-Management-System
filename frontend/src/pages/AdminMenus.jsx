...
export default function AdminMenus({ isEmbedded = false }) {
    ...
    <div>
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div className={isEmbedded ? "" : "flex-1"}>
          ...
          {!isEmbedded && <p className="text-slate-400">View all restaurants and their food items</p>}
        </div>
      </div>
  ...
  if (loading) {
    return (
      <div className={isEmbedded ? "flex justify-center items-center py-12" : "min-h-screen bg-brand-navy flex justify-center items-center"}>
