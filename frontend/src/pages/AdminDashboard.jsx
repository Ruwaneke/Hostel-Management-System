...
const stats = [
  { label: "Total Rooms",    value: 48,  icon: "", color: "primary" },
  { label: "Occupied",       value: 35,  icon: "",  color: "accent"  },
  { label: "Total Students", value: 127, icon: "",  color: "accent"   },
  { label: "Open Tickets",   value: 8,   icon: "",  color: "red"    },
];

const colorCls = {
  primary: { border: "border-l-[#14213d]", text: "text-[#14213d]", bg: "bg-[#14213d] bg-opacity-5" },
  accent:  { border: "border-l-[#fca311]",  text: "text-[#fca311]",  bg: "bg-[#fca311] bg-opacity-5"  },
      ...
      case "dashboard":
        return (
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-[#14213d] to-[#1a2a4a] rounded-2xl p-6 text-white">
              ...
              <div className="grid grid-cols-3 gap-4 text-center mt-4">
                {[["8","Open Tickets"],["3","Pending Payments"],["2","Laundry Ready"]].map(([v, l]) => (
                  <div key={l} className="bg-white/10 rounded-xl p-3">
                    ...
                    <div className="text-xs text-[#fca311] mt-1">{l}</div>
                  </div>
                ))}
              </div>
            </div>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="bg-white border-b border-slate-200 px-6 py-3 flex items-center justify-between flex-shrink-0">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="w-9 h-9 text-white rounded-full flex items-center justify-center font-bold text-sm" style={{backgroundColor: "#14213d"}}>
