...
export default function AdminRestaurants({ isEmbedded = false }) {
    ...
    <div>
      ...
      <div className="flex items-center justify-between mb-8 gap-4">
        ...
        <div className={isEmbedded ? "" : "flex-1"}>
          <h1 className={`font-extrabold ${isEmbedded ? "text-xl text-brand-black" : "text-4xl text-brand-gold"}`}>
            Restaurant Management
          </h1>
          {!isEmbedded && <p className="text-slate-400 mt-2">Manage all restaurants and their food items</p>}
        </div>
        <button
              ...
              <div className="p-6">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex-1 bg-gradient-to-r from-cyan-500 to-blue-600 hover:shadow-lg text-white font-bold py-2.5 px-3 rounded-lg transition-all text-sm transform hover:scale-105 flex items-center justify-center gap-1"
                  >
                    View
                  </button>
                  <button
                    onClick={() => handleEdit(restaurant)}
                    className="flex-1 bg-gradient-to-r from-amber-400 to-orange-500 hover:shadow-lg text-white font-bold py-2.5 px-3 rounded-lg transition-all text-sm transform hover:scale-105 flex items-center justify-center gap-1"
                  >
                    Edit
                  </button>
                  <button
                    onClick={() => handleDelete(restaurant._id)}
                    className="flex-1 bg-gradient-to-r from-rose-500 to-pink-600 hover:shadow-lg text-white font-bold py-2.5 px-3 rounded-lg transition-all text-sm transform hover:scale-105 flex items-center justify-center gap-1"
                  >
                    Delete
                  </button>
                </div>
